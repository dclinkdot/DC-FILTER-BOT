...
URL = "https://dc-filter-bot-7n2l.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://dc-filter-bot-7n2l.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://dc-filter-bot-7n2l.onrender.com/".format(FQDN)
else:
    URL = "https://dc-filter-bot-7n2l.onrender.com/".format(FQDN)
