...
API_ID = int(environ.get('API_ID', '23679347'))
API_HASH = environ.get('API_HASH', '7de55f9c943538839c4bdb877724a773')
BOT_TOKEN = environ.get('BOT_TOKEN', "6850092163:AAENu0vhQPwavCjy86wcTWHu7j_sULzrkVY")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5421323272').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nn0698218:3hj9j9pyiEWTQM0v@cluster0.dvdhx9p.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002050296338')
...
URL = "https://dc-filter-bot-yrk4.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://dc-filter-bot-yrk4.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://dc-filter-bot-yrk4.onrender.com/".format(FQDN)
else:
    URL = "https://dc-filter-bot-yrk4.onrender.com/".format(FQDN)
